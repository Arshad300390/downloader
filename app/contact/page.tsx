      ...
      <div className="bg-white bg-opacity-80 rounded-3xl shadow-2xl p-8 max-w-lg w-full text-center animate-fade-in mb-12">
        ...
        <div className="mt-8 flex justify-center">
          ...
          <a
            ...
            className="px-8 py-4 bg-[#25D366] text-white text-lg font-bold rounded-full shadow-lg hover:scale-105 transition-transform flex items-center justify-center gap-3"
          >
            <svg 
              width="24" 
              height="24" 
