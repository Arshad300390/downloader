...
export default function Contact() {
  // Replace this with your actual phone number (include country code, no symbols)
  const phoneNumber = "03489686876"; 
      ...
      <div className="bg-white bg-opacity-80 rounded-3xl shadow-2xl p-8 max-w-lg w-full text-center animate-fade-in mb-12">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            className="px-6 py-3 bg-[#25D366] text-white font-bold rounded-full shadow-lg hover:scale-105 transition-transform flex items-center justify-center gap-2"
          >
            <svg 
              width="20" 
              height="20" 
